...
public enum MaterialGroup{
    ...
    @Kapi
    SWORD(Set.of(Material.WOODEN_SWORD,
    ...
    @Kapi
    PICKAXE(Set.of(Material.WOODEN_PICKAXE,
    ...
    @Kapi
    AXE(Set.of(Material.WOODEN_AXE,
               Material.STONE_AXE,
               Material.IRON_AXE,
               Material.GOLDEN_AXE,
    ...
    @Kapi
    SHOVEL(Set.of(Material.WOODEN_SHOVEL,
    ...
    @Kapi
    HOE(Set.of(Material.WOODEN_HOE,
               Material.STONE_HOE,
               Material.IRON_HOE,
               Material.GOLDEN_HOE,
